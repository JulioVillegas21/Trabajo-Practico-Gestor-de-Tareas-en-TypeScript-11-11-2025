...
import { crearTarea, mostrarse,agregarTarea,mostrarTitulo,recibirDato, editarTarea, editarTareaPorIndice } from './Tarea.js';
import { menuDificultad,menuEstados,menu } from './Menus.js';
import { FiltrarEstados, VerTodasLasTareas, ImprimirTitulos } from './funciones.js';
...
const Estados:string[]=["pendiente","en progreso","terminada","cancelada"];
let n:number;
...
do{
    ...
    switch(n=parseInt(prompt("Ingrese una opcion: "))){
        case 1:
        let nuevaTarea:Tarea=recibirDato(Dificultad);
        ...
        break;
        case 3:
        let tituloBuscar:string=prompt("Ingrese el titulo de la tarea a buscar: ");
        ...
        if(idx !== -1){
            ...
            let option=prompt("Seleccione (E) para editar o otra letra para volver al menu: ");
